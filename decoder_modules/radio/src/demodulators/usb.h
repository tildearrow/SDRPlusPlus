...
namespace demod {
    ...
    public:
        ...
        void init(std::string name, ConfigManager* config, dsp::stream<dsp::complex_t>* input, double bandwidth, double audioSR) {
            ...
            // Define structure
            demod.init(input, dsp::demod::SSB<dsp::stereo_t>::Mode::USB, bandwidth, getIFSampleRate(), agcAttack / getIFSampleRate(), agcDecay / getIFSampleRate(), agcBypass);
        }
        ...
        void showMenu() {
            ...
            ImGui::SetNextItemWidth(menuWidth - ImGui::GetCursorPosX());
            if (ImGui::SliderFloat(("##_radio_usb_agc_bypass_" + name).c_str(), &agcBypass, -1.0f, 100.0f)) {
